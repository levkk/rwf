...
pub fn migrations() -> Vec<RwfDatabaseSchema> {
    [
        RwfDatabaseSchema {
            ...
            info: include_str!("bootstrap/1_migrations.info.yaml").to_string(),
        ...
        RwfDatabaseSchema {
            id: 2i64,
            name: "jobs".to_string(),
            info: include_str!("bootstrap/2_jobs.info.yaml").to_string(),
        ...
        RwfDatabaseSchema {
            ...
            info: include_str!("bootstrap/3_requests_tracking.info.yaml").to_string(),
        ...
        RwfDatabaseSchema {
            ...
            info: include_str!("bootstrap/4_static_file_metadata.info.yaml").to_string(),
        },
    ]
        .to_vec()
}
